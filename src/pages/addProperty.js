...
const AddProperty = () => {
    ...
    const residentialNames = ['Apartment', 'Villa', 'Plot', 'Builder Floor', 'Penthouse', 'PG', 'Independent House'];
    const commercialNames = ['Office Space', 'Shop', 'Land', 'Showroom', 'Warehouse', 'Industrial Plot', 'Office place in IT/SEZ'];
    const securityNames = ['Zero Deposit', 'One Month', 'Two Month'];
    const additionalRoomNames = ['Pooja Room', 'Study Room', 'Servent Room', 'Extra Room'];
    ...
    const viewFacingOptions = [
        ...
        "Main Road",
        "Garden/Park",
        "Pool", "Beach View", "North", "North West", "North East", "Others"
    ];
    ...
    const handlePostProperty = async () => {
        ...
        //     parking === ''
        //   ) {
        //     // Display an error message or perform necessary actions for invalid input
        ...
        try {
            ...
            const response = await fetch('https://my-property-go-backend.onrender.com/api/agent/property/addProperty', {
                method: 'POST',
                headers: {
    ...
    return <>
        ...
        <div className=" mx-auto w-full lg:w-[900px] max-w-3xl  ">
            ...
            <div className="property-listing-form">
                ...
                <h3 style={{ margin: "10px 0" }} className="text-3xl font-semibold text-TitleColor">
                    Add New Property
                </h3>
                <button
                    style={{}}
                ...
                <p style={{ marginBottom: "15px", marginTop: "15px" }}>Property Listing Form:</p>
                ...
                <p style={{ marginBottom: "15px", marginTop: "15px" }}>Building Type</p>
                ...
                <p style={{ marginBottom: "15px", marginTop: "15px" }}>Property Type</p>
                {residentialActive ? <div className="propertyTypeContainer">
                ...
                </div> : <div className="propertyTypeContainer">
                        ...
                        <div className="securityDepositDiv">
                            {securityNames.map((name, index) => (
                                <button
                                    ...
                                    className={`button ${securityActiveButton === name ? 'active' : ''}`}
                                >
                                    {name}
                                </button>
                            ))}
...
{/* Image Upload Function */}
                        ...
                        <select style={{ width: "50%", margin: "10px", height: "30px" }} value={selectedViewFacing} onChange={handleViewFacingChange}>
                        ...
                        <h2 style={{ fontWeight: "bold" }}>Amenities:</h2>
                        <div style={{ display: "flex", flexWrap: "wrap" }}>
                            {availableAmenities.map((amenity, index) => (
                                <div style={{ margin: "5px", display: "flex", padding: "5px", alignItems: "center" }} className="amenitiesDiv">
                                    <input
                                        required
                                    ...
                                    />
                                    <label style={{ margin: "0" }} key={index} className="amenity-checkbox">
                        ...
                        <h2 style={{ fontWeight: "bold", marginBottom: "10px" }} >Property Description</h2>
                        <span>Please write a detailed description about property so clients can understand property better </span>
                        <textarea onChange={(e) => setDescription(e.target.value)} placeholder="A detailed description means  70% higher chance of Leads" style={{ width: "100%", padding: "7px", marginTop: "10px" }} name="" id="" cols="30" rows="5"></textarea>
                        ...
                        <button onClick={handlePostProperty} style={{ margin: "20px", backgroundColor: "rgb(88,191,147)", padding: "15px", borderRadius: "10px" }}>Save & Continue</button>
